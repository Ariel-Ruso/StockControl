    ...
    <div class="col-md-6">
      <div class="card bg-white shadow">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('celulares.store') }}" 
                method="POST" 
            ...
            <div class="container " name="etiquetas">
              <div class="row justify-content-center ">
                <div class="col-md-8 ">
                  ...
                  <input type="number" name="codigo" value={{ $ultArt->codigo + 1}} class="form-control mb-2 col-3 " />
                  ...
                  <textarea rows="4", cols="54" id="descripcion" name="descripcion" 
                            placeholder="Especificaciones : Procesador, Ram, Espacio etc" 
                            style="resize:none, " class="form-control mb-2 " >
                  </textarea>
                  ...
                  <input  type="hidden" step="any" id="categorias_id" 
                          name="categorias_id"
                          class="form-control mb-2 col-6" value= "6"  /> 
