  ...
  <tr>
    ...
    <th >
     {{-- col derecha --}}
      ...
      <x-agrega-btn route="celulares/create" 
                    destino="Crear" />
      <br><br>
  ...
  <div class="container mt-4">
    <div class="row justify-content-center mx-auto ">
          ...
          <table class="table border-rounded shadow" >
            ...
            <tbody>
              @foreach($celus as $item)
                <tr class="font text-xs text-center " width= "100%"> 
                  {{-- <td>
                    {{ $item->codigo }}
                  </td> --}}
                  <td>  
                    <a href=" {{ route('celulares.show', $item) }}">
                      {{ $item->nombre }}
                    </a>
                  </td>
                ...
                {{--   <td>
                  ...
                  <td>
                      <a  href="{{ route ('celulares.edit', $item) }}" 
                                      ...
                                      <div class="modal-dialog">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                  ...
                                                  <form action= "{{ route('celulares.destroy', $item->id) }}" 
                                                        method="post" 
                                                        class="d-inline" >
                                                          @method ('DELETE')
                                                          @csrf
